            ...
            <div className="container mx-auto">
                <div className="flex gap-8 mt-20  lg:pb-10 items-center justify-center flex-col">
                    ...
                    <div className="flex gap-4 flex-col">
                        ...
                        <p className="text-sm md:text-lg leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center font-serif">
                            Undictify: A quiet rebellion against digital
                            addiction, helping you reclaim control of your
                            online life.
                        </p>
                    </div>
